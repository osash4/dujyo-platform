...
// Structure for the Main Wallet of Dujyo
#[derive(Debug, Clone)]
...
impl DujyoMainWallet {
    pub fn new() -> Self {
        // Generate seed phrase of 24 words (BIP39)
        ...
        // Generate address Dujyo from public key
    ...
    fn generate_seed_phrase() -> String {
        // List of phrase BIP39 words (simplified for demo)
        let words = vec![
